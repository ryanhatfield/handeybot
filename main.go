...
var profileURL = "http://images.usatoday.com/Wires2Web/20080412/2997740568_Books_Jack_Handeyx.jpg"
...
func main() {
	...
	g.Send(&glack.Message{Channel: *channel, Icon: profileURL, Username: "Jack Handey", Message: quotes[rand.Intn(len(quotes))]})
}
